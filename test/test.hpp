...
#ifndef OPERA_TEST_HPP
#define OPERA_TEST_HPP
...
#define OPERA_TEST_CLASS(classname,testclassconstruct)                       \
    { \
        std::cout << "****************************************\n"       \
                  << "TESTING CLASS " << #classname << "\n"                    \
                  << "****************************************\n" << std::endl; \
        OPERA_CURRENT_TESTING_CLASS=#classname; \
        testclassconstruct.test(); \
    } \

/*! \brief Print the title for the test case */
#define OPERA_PRINT_TEST_CASE_TITLE( pTitle )                         \
    {                                                                   \
...
#define OPERA_PRINT_TEST_COMMENT( pComment )                          \
    {                                                                   \
...
#define OPERA_TEST_WARN( message )                                    \
    {                                                                   \
...
#define OPERA_TEST_NOTIFY( message )                                    \
    {                                                                   \
...
#define OPERA_TEST_CATCH(message)                                     \
...
#define OPERA_TEST_CALL(function)                                     \
    {                                                                   \
        std::cout << "****************************************\n"       \
                  << "CALLING " << #function << "\n"                    \
                  << "****************************************\n" << std::endl; \
...
#define OPERA_TEST_SKIP(function)                                     \
    {                                                                   \
        std::cout << "****************************************\n"       \
                  << "SKIPPING " << #function << "\n"                   \
                  << "****************************************\n" << std::endl; \
...
#define OPERA_TEST_EXECUTE(statement)                                 \
    {                                                                   \
...
/*! \brief Tries to execute \a statement, writing the statement to standard output. Writes a diagnostic report to standard error if an exception is thrown. <br> <b>Important:</b> Use the OPERA_TEST_CONSTRUCT() macro if \a statement declares a variable and calls a constructor. */
#define OPERA_TEST_TRY(statement)                                     \
    {                                                                   \
        std::cout << #statement << ": " << std::flush;                  \
        try {                                                           \
            statement;                                                  \
            ...
            OPERA_TEST_CATCH("Statement `" << #statement << "'")      \
        }                                                               \


/*! \brief Writes the expression to the output. Does not catch errors. */
#define OPERA_TEST_PRINT(expression)                                  \
    {                                                                   \
...
#define OPERA_TEST_EVALUATE(expression)                               \
    {                                                                   \
        std::cout << #expression << ": " << std::flush;                 \
        try {                                                           \
            std::cout << (expression) << "\n" << std::endl;             \
        }                                                               \
            OPERA_TEST_CATCH("Expression `" << #expression << "'")    \
        }                                                               \


/*! \brief Evaluates \a expression in a boolean context and checks if the result is \a true. */
#define OPERA_TEST_ASSERT(expression)                                 \
    {                                                                   \
        std::cout << #expression << ": " << std::flush;                 \
...
#define OPERA_TEST_SAME(expression1,expression2)                         \
    {                                                                   \
...
#define OPERA_TEST_SAME_AS(expression,expected)                         \
    {                                                                   \
...
#define OPERA_TEST_WITHIN(expression,expected,tolerance)                         \
    {                                                                   \
        std::cout << #expression << " ~ " << #expected << ": " << std::flush; \
...
#define OPERA_TEST_RESULT_COMPARE(Type,expression,comparison,expected) \
    {                                                                   \
...
#define OPERA_TEST_DECLARE(Class,variable)                            \
    {                                                                   \
...
#define OPERA_TEST_CONSTRUCT(Class,variable,expression)               \
    {                                                                   \
        ...
        OPERA_TEST_CATCH("Constructor `" << #Class << " " << #variable << "" << #expression << "'") \
    }                                                                   \
    Class variable expression;                                          \
*/

/*! \brief Constructs object \a variable of type \a Class from \a expression. */
#define OPERA_TEST_NAMED_CONSTRUCT(Class,variable,expression)               \
    {                                                                   \
        ...
        OPERA_TEST_CATCH("Named constructor `" << #variable << "=" << #Class << "::" << #expression << "'") \
    }                                                                   \
    Class variable = Class :: expression;                                          \


/*! \brief Construct object \a variable of type \a Class from \a expression using assignment syntax. */
#define OPERA_TEST_ASSIGN_CONSTRUCT(Class,variable, expression)       \
    {                                                                   \
        std::cout << #Class << " " << #variable << " = " << #expression << ": " << std::flush; \
        try {                                                           \
            Class variable = expression;                                \
        ...
        OPERA_TEST_CATCH("Assignment `" << #variable << "=" << #expression << "'") \
    }                                                                   \
    Class variable = expression;                                        \

/*! \brief Assigns object \a variable from \a expression. */
#define OPERA_TEST_ASSIGN(variable, expression)                       \
    {                                                                   \
...
#define OPERA_TEST_THROWS(statement,error)                             \
    {                                                                   \
        std::cout << #statement << ": " << std::flush;                  \
        try {                                                           \
            statement;                                                  \
...
/*! \brief Evaluates expression and expects an exception. */
#define OPERA_TEST_FAIL(statement)                                    \
    {                                                                   \
        std::cout << #statement << ": " << std::flush;                  \
        try {                                                           \
            statement;                                                  \
...
#define OPERA_TEST_STATIC_ASSERT(...)                          \
    {                                                                   \
        ...
        if(result) {                                                    \
            ...
            ++OPERA_TEST_FAILURES;                                    \
            std::cout << "false\n" << std::endl;                 \
            std::cout << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << OPERA_CURRENT_TESTING_CLASS << ": Static assertion `" << #__VA_ARGS__ << "' failed." << "\n" << std::endl; \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << OPERA_CURRENT_TESTING_CLASS << ": Static assertion `" << #__VA_ARGS__ << "' failed." << std::endl; \
        }                                                               \
    }                                                                   \

/*! \brief Evaluates \a concept in a boolean context and checks if the result is \a true. */
/*! Use variadic macro argument to allow template parameters */
#define OPERA_TEST_CONCEPT(...)                          \
    {                                                                   \
        std::cout << #__VA_ARGS__ << ": " << std::flush;                 \
        ...
        if(result) {                                                    \
            ...
            ++OPERA_TEST_FAILURES;                                    \
            std::cout << "false\n" << std::endl;                 \
            std::cout << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << OPERA_CURRENT_TESTING_CLASS << ": Concept `" << #__VA_ARGS__ << "' failed." << "\n" << std::endl; \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << OPERA_CURRENT_TESTING_CLASS << ": Concept `" << #__VA_ARGS__ << "' failed." << std::endl; \
        }                                                               \
    }                                                                   \
...
#define OPERA_TEST_SAME_TYPE(...)                          \
    {                                                                   \
        ...
        if(result) {                                                    \
            ...
            ++OPERA_TEST_FAILURES;                                    \
            std::cout << "false\n" << std::endl;                 \
            std::cout << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << OPERA_CURRENT_TESTING_CLASS << ": Static assertion `Same<" << #__VA_ARGS__ << ">' failed." << " First type is " << class_name<typename First<__VA_ARGS__>::Type>() << "\n" << std::endl; \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << OPERA_CURRENT_TESTING_CLASS << ": Static assertion `Same<" << #__VA_ARGS__ << ">' failed." << " First type is " << class_name<typename First<__VA_ARGS__>::Type>() << std::endl; \
        }                                                               \
    }                                                                   \
...
/*! Use variadic macro argument to allow template parameters */
#define OPERA_TEST_EQUIVALENT_TYPE(...)                          \
    {                                                                   \
        ...
        if(result) {                                                    \
            ...
            ++OPERA_TEST_FAILURES;                                    \
            std::cout << "false\n" << std::endl;                 \
            std::cout << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << OPERA_CURRENT_TESTING_CLASS << ": Static assertion `IsEquivalent<" << #__VA_ARGS__ << ">' failed." << " First type is " << class_name<typename First<__VA_ARGS__>::Type>() << "\n" << std::endl; \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << OPERA_CURRENT_TESTING_CLASS << ": Static assertion `IsEquivalent<" << #__VA_ARGS__ << ">' failed." << " First type is " << class_name<typename First<__VA_ARGS__>::Type>() << std::endl; \
        }                                                               \
    }                                                                   \
 ...
 */
#define OPERA_TEST_GRID_TREE_SUBPAVING_ITERATOR( expected_result, theGridTreeSubpaving, expected_number_elements ) \
    {                                                                   \
        ...
        for (GridTreeSubpaving::ConstIterator it = theGridTreeSubpaving.begin(), end = theGridTreeSubpaving.end(); it != end; it++, elements_count++) { \
            if( elements_count < expected_number_elements ) {           \
                OPERA_PRINT_TEST_COMMENT("The next Iterator node is: "); \
                OPERA_TEST_COMPARE( (*expected_result[elements_count]), == , (*it) ); \
            }                                                           \
        }                                                               \
        OPERA_PRINT_TEST_COMMENT("Test that we iterated through the right number of nodes"); \
        OPERA_TEST_EQUAL( elements_count , expected_number_elements ); \
    }                                                                   \


/*! \brief clean std::vector, i.e. delete memory of it's non NULL elements and set them to NULL in the vector */
#define OPERA_CLEAN_TEST_VECTOR( vector ) \
    { \
