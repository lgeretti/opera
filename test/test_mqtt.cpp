...
public:
    ...
    void test_broker() {
        ...
        bp_received.set_add_callback([](auto p){ ARIADNE_PRINT_TEST_COMMENT("received body presentation") });
        bs_received.set_add_callback([](auto p){ ARIADNE_PRINT_TEST_COMMENT("received body state") });
        cn_received.set_add_callback([](auto p){ ARIADNE_PRINT_TEST_COMMENT("received collision notification") });
